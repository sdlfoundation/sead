...
public:
  // The value for each enumerator in the following enums has been confirmed to
  // be platform-specific when comparing sead between several platforms (3DS,
  // Wii U, Switch)
...
protected:
  ...
  virtual void setBlendFactorImpl(BlendFactor src_factor_rgb,
                                  BlendFactor dst_factor_rgb,
                                  BlendFactor src_factor_a,
                                  BlendFactor dst_factor_a);
  virtual void setBlendFactorMRTImpl(u32 target, BlendFactor src_factor_rgb,
                                     BlendFactor dst_factor_rgb,
                                     BlendFactor src_factor_a,
                                     BlendFactor dst_factor_a);
  virtual void setBlendEquationImpl(BlendEquation equation_rgb,
  ...
  virtual void setStencilTestOpImpl(StencilOp fail, StencilOp zfail,
                                    StencilOp zpass);
  virtual void setPolygonModeImpl(PolygonMode front, PolygonMode back);
  virtual void setPolygonOffsetEnableImpl(bool fill_front_enable,
...
public:
  ...
  void setDepthFunc(Graphics::DepthFunc func) { setDepthFuncImpl(func); }
  ...
  void setBlendFactorSeparate(BlendFactor src_factor_rgb,
                              BlendFactor dst_factor_rgb,
                              BlendFactor src_factor_a,
                              BlendFactor dst_factor_a) {
    setBlendFactorImpl(src_factor_rgb, dst_factor_rgb, src_factor_a,
                       dst_factor_a);
  }

  void setBlendFactorMRT(u32 target, BlendFactor src_factor,
                         BlendFactor dst_factor) {
    setBlendFactorMRTImpl(target, src_factor, dst_factor, src_factor,
                          dst_factor);
  }
  ...
  void setBlendFactorSeparateMRT(u32 target, BlendFactor src_factor_rgb,
                                 ...
                                 BlendFactor src_factor_a,
                                 BlendFactor dst_factor_a) {
    setBlendFactorMRTImpl(target, src_factor_rgb, dst_factor_rgb, src_factor_a,
                          dst_factor_a);
  }
  ...
  void setBlendEquationSeparate(BlendEquation equation_rgb,
                                BlendEquation equation_a) {
  ...
  void setAlphaTestEnable(bool enable) { setAlphaTestEnableImpl(enable); }
